export type VMixInputType = "Mix" | "Colour" | "VideoList" | "Video" | "Image" | "AudioFile";
...
export type InputType = ListInput | ColourInput | MixInput | VideoInput | ImageInput | AudioFileInput;
