...
const InputType = z.enum(["Mix", "Colour", "VideoList", "Video", "Image", "AudioFile"] as const).or(z.string());
...
export const VMixRawXMLSchema = z.object({
    vmix: z.object({
        version: z.string(),
        edition: z.string(),
        preset: z.string(),
