...
export const ProcessMediaJobUpdateManyWithoutMediaNestedInputSchema: z.ZodType<Prisma.ProcessMediaJobUpdateManyWithoutMediaNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default ProcessMediaJobUpdateManyWithoutMediaNestedInputSchema;
