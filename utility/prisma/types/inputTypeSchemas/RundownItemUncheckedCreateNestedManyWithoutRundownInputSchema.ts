...
export const RundownItemUncheckedCreateNestedManyWithoutRundownInputSchema: z.ZodType<Prisma.RundownItemUncheckedCreateNestedManyWithoutRundownInput> = z.object({
...
export default RundownItemUncheckedCreateNestedManyWithoutRundownInputSchema;
