...
export const RundownUncheckedCreateNestedManyWithoutShowInputSchema: z.ZodType<Prisma.RundownUncheckedCreateNestedManyWithoutShowInput> = z.object({
...
export default RundownUncheckedCreateNestedManyWithoutShowInputSchema;
