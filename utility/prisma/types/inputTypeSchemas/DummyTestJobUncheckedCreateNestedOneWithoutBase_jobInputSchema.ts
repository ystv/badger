...
export const DummyTestJobUncheckedCreateNestedOneWithoutBase_jobInputSchema: z.ZodType<Prisma.DummyTestJobUncheckedCreateNestedOneWithoutBase_jobInput> =
  z
    .object({
      create: z
        .union([
...
export default DummyTestJobUncheckedCreateNestedOneWithoutBase_jobInputSchema;
