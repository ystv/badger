...
export const ProcessMediaJobUncheckedUpdateManyInputSchema: z.ZodType<Prisma.ProcessMediaJobUncheckedUpdateManyInput> =
  z
    .object({
      id: z
        .union([
...
export default ProcessMediaJobUncheckedUpdateManyInputSchema;
