...
export const LoadAssetJobUncheckedUpdateManyWithoutAssetInputSchema: z.ZodType<Prisma.LoadAssetJobUncheckedUpdateManyWithoutAssetInput> =
  z
    .object({
      id: z
        .union([
...
export default LoadAssetJobUncheckedUpdateManyWithoutAssetInputSchema;
