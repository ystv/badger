...
export const AssetUpdateOneWithoutMediaNestedInputSchema: z.ZodType<Prisma.AssetUpdateOneWithoutMediaNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default AssetUpdateOneWithoutMediaNestedInputSchema;
