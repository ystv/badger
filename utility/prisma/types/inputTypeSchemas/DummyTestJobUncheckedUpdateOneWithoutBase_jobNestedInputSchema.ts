...
export const DummyTestJobUncheckedUpdateOneWithoutBase_jobNestedInputSchema: z.ZodType<Prisma.DummyTestJobUncheckedUpdateOneWithoutBase_jobNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default DummyTestJobUncheckedUpdateOneWithoutBase_jobNestedInputSchema;
