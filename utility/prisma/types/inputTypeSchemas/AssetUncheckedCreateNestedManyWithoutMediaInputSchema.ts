...
export const AssetUncheckedCreateNestedManyWithoutMediaInputSchema: z.ZodType<Prisma.AssetUncheckedCreateNestedManyWithoutMediaInput> = z.object({
...
export default AssetUncheckedCreateNestedManyWithoutMediaInputSchema;
