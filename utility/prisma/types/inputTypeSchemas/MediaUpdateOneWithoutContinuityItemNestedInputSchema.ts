...
export const MediaUpdateOneWithoutContinuityItemNestedInputSchema: z.ZodType<Prisma.MediaUpdateOneWithoutContinuityItemNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default MediaUpdateOneWithoutContinuityItemNestedInputSchema;
