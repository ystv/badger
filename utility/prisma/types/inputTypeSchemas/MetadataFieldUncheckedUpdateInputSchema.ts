...
import { MetadataUncheckedUpdateManyWithoutFieldNestedInputSchema } from './MetadataUncheckedUpdateManyWithoutFieldNestedInputSchema';

export const MetadataFieldUncheckedUpdateInputSchema: z.ZodType<Prisma.MetadataFieldUncheckedUpdateInput> = z.object({
  ...
  values: z.lazy(() => MetadataUncheckedUpdateManyWithoutFieldNestedInputSchema).optional()
}).strict();

export default MetadataFieldUncheckedUpdateInputSchema;
