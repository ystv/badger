...
export const DummyTestJobUpdateManyWithoutBase_jobNestedInputSchema: z.ZodType<Prisma.DummyTestJobUpdateManyWithoutBase_jobNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default DummyTestJobUpdateManyWithoutBase_jobNestedInputSchema;
