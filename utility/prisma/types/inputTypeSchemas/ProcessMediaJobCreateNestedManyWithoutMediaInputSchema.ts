...
export const ProcessMediaJobCreateNestedManyWithoutMediaInputSchema: z.ZodType<Prisma.ProcessMediaJobCreateNestedManyWithoutMediaInput> =
  z
    .object({
      create: z
        .union([
...
export default ProcessMediaJobCreateNestedManyWithoutMediaInputSchema;
