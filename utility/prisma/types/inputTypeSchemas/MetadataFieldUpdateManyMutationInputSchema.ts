...
export const MetadataFieldUpdateManyMutationInputSchema: z.ZodType<Prisma.MetadataFieldUpdateManyMutationInput> = z.object({
...
export default MetadataFieldUpdateManyMutationInputSchema;
