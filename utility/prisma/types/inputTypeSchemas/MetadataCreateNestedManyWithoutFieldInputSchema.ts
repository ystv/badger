...
export const MetadataCreateNestedManyWithoutFieldInputSchema: z.ZodType<Prisma.MetadataCreateNestedManyWithoutFieldInput> = z.object({
...
export default MetadataCreateNestedManyWithoutFieldInputSchema;
