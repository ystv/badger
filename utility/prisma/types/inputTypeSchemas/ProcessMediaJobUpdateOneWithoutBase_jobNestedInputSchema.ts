...
export const ProcessMediaJobUpdateOneWithoutBase_jobNestedInputSchema: z.ZodType<Prisma.ProcessMediaJobUpdateOneWithoutBase_jobNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default ProcessMediaJobUpdateOneWithoutBase_jobNestedInputSchema;
