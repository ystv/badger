...
export const AssetUncheckedUpdateWithoutLoadJobsInputSchema: z.ZodType<Prisma.AssetUncheckedUpdateWithoutLoadJobsInput> =
  z
    .object({
      id: z
        .union([
...
export default AssetUncheckedUpdateWithoutLoadJobsInputSchema;
