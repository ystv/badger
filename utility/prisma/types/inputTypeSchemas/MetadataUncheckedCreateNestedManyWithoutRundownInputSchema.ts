...
export const MetadataUncheckedCreateNestedManyWithoutRundownInputSchema: z.ZodType<Prisma.MetadataUncheckedCreateNestedManyWithoutRundownInput> = z.object({
...
export default MetadataUncheckedCreateNestedManyWithoutRundownInputSchema;
