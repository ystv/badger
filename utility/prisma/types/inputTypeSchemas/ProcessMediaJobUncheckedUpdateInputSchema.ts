...
export const ProcessMediaJobUncheckedUpdateInputSchema: z.ZodType<Prisma.ProcessMediaJobUncheckedUpdateInput> =
  z
    .object({
      id: z
        .union([
...
export default ProcessMediaJobUncheckedUpdateInputSchema;
