...
export const ShowUncheckedUpdateWithoutContinuityItemsInputSchema: z.ZodType<Prisma.ShowUncheckedUpdateWithoutContinuityItemsInput> = z.object({
  ...
  metadata: z.lazy(() => MetadataUncheckedUpdateManyWithoutShowNestedInputSchema).optional()
}).strict();
