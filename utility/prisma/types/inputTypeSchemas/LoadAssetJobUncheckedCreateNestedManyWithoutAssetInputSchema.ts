...
export const LoadAssetJobUncheckedCreateNestedManyWithoutAssetInputSchema: z.ZodType<Prisma.LoadAssetJobUncheckedCreateNestedManyWithoutAssetInput> =
  z
    .object({
      create: z
        .union([
...
export default LoadAssetJobUncheckedCreateNestedManyWithoutAssetInputSchema;
