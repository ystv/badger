...
export const ProcessMediaJobUncheckedCreateNestedOneWithoutBase_jobInputSchema: z.ZodType<Prisma.ProcessMediaJobUncheckedCreateNestedOneWithoutBase_jobInput> =
  z
    .object({
      create: z
        .union([
...
export default ProcessMediaJobUncheckedCreateNestedOneWithoutBase_jobInputSchema;
