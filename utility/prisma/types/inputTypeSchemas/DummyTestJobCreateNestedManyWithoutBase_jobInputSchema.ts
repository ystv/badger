...
export const DummyTestJobCreateNestedManyWithoutBase_jobInputSchema: z.ZodType<Prisma.DummyTestJobCreateNestedManyWithoutBase_jobInput> =
  z
    .object({
      create: z
        .union([
...
export default DummyTestJobCreateNestedManyWithoutBase_jobInputSchema;
