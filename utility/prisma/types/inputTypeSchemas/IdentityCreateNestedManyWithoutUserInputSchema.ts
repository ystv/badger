...
export const IdentityCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.IdentityCreateNestedManyWithoutUserInput> = z.object({
...
export default IdentityCreateNestedManyWithoutUserInputSchema;
