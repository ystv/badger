...
export const AssetUncheckedCreateNestedManyWithoutRundownInputSchema: z.ZodType<Prisma.AssetUncheckedCreateNestedManyWithoutRundownInput> = z.object({
...
export default AssetUncheckedCreateNestedManyWithoutRundownInputSchema;
