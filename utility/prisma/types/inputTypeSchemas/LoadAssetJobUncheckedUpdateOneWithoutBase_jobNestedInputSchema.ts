...
export const LoadAssetJobUncheckedUpdateOneWithoutBase_jobNestedInputSchema: z.ZodType<Prisma.LoadAssetJobUncheckedUpdateOneWithoutBase_jobNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default LoadAssetJobUncheckedUpdateOneWithoutBase_jobNestedInputSchema;
