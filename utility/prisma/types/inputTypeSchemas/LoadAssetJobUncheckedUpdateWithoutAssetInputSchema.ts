...
export const LoadAssetJobUncheckedUpdateWithoutAssetInputSchema: z.ZodType<Prisma.LoadAssetJobUncheckedUpdateWithoutAssetInput> =
  z
    .object({
      id: z
        .union([
...
export default LoadAssetJobUncheckedUpdateWithoutAssetInputSchema;
