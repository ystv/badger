...
export const LoadAssetJobCreateNestedOneWithoutBase_jobInputSchema: z.ZodType<Prisma.LoadAssetJobCreateNestedOneWithoutBase_jobInput> =
  z
    .object({
      create: z
        .union([
...
export default LoadAssetJobCreateNestedOneWithoutBase_jobInputSchema;
