...
export const BaseJobUpdateWithoutProcessMediaJobInputSchema: z.ZodType<Prisma.BaseJobUpdateWithoutProcessMediaJobInput> =
  z
    .object({
      workerId: z
        .union([
...
export default BaseJobUpdateWithoutProcessMediaJobInputSchema;
