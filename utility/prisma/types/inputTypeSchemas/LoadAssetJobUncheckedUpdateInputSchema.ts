...
export const LoadAssetJobUncheckedUpdateInputSchema: z.ZodType<Prisma.LoadAssetJobUncheckedUpdateInput> =
  z
    .object({
      id: z
        .union([
...
export default LoadAssetJobUncheckedUpdateInputSchema;
