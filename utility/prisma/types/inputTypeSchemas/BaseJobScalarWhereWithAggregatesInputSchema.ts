...
export const BaseJobScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.BaseJobScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => BaseJobScalarWhereWithAggregatesInputSchema),z.lazy(() => BaseJobScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  ...
  workerId: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  state: z.union([ z.lazy(() => EnumJobStateWithAggregatesFilterSchema),z.lazy(() => JobStateSchema) ]).optional(),
  ...
  manuallyTriggered: z.union([ z.lazy(() => BoolWithAggregatesFilterSchema),z.boolean() ]).optional(),
  externalJobProvider: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  externalJobID: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
