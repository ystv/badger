...
export const MediaUpdateOneWithoutRundownItemNestedInputSchema: z.ZodType<Prisma.MediaUpdateOneWithoutRundownItemNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default MediaUpdateOneWithoutRundownItemNestedInputSchema;
