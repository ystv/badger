...
export const MetadataFieldFindFirstOrThrowArgsSchema: z.ZodType<Omit<Prisma.MetadataFieldFindFirstOrThrowArgs, "select" | "include">> = z.object({
...
export default MetadataFieldFindFirstOrThrowArgsSchema;
