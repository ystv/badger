...
export const ConnectionFindManyArgsSchema: z.ZodType<Omit<Prisma.ConnectionFindManyArgs, "select" | "include">> = z.object({
...
export default ConnectionFindManyArgsSchema;
