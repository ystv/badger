...
export const IdentityFindFirstOrThrowArgsSchema: z.ZodType<Omit<Prisma.IdentityFindFirstOrThrowArgs, "select" | "include">> = z.object({
...
export default IdentityFindFirstOrThrowArgsSchema;
