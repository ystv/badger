...
export const DummyTestJobFindFirstArgsSchema: z.ZodType<
  Omit<Prisma.DummyTestJobFindFirstArgs, "select" | "include">
> = z
  .object({
...
export default DummyTestJobFindFirstArgsSchema;
