...
export const ContinuityItemFindManyArgsSchema: z.ZodType<Omit<Prisma.ContinuityItemFindManyArgs, "select" | "include">> = z.object({
...
export default ContinuityItemFindManyArgsSchema;
