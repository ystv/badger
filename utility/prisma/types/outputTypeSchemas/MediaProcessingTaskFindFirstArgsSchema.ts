...
export const MediaProcessingTaskFindFirstArgsSchema: z.ZodType<Omit<Prisma.MediaProcessingTaskFindFirstArgs, "select" | "include">> = z.object({
...
export default MediaProcessingTaskFindFirstArgsSchema;
