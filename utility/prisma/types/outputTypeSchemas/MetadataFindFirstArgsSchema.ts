...
export const MetadataFindFirstArgsSchema: z.ZodType<Omit<Prisma.MetadataFindFirstArgs, "select" | "include">> = z.object({
...
export default MetadataFindFirstArgsSchema;
