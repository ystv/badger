...
export const RundownItemFindFirstOrThrowArgsSchema: z.ZodType<Omit<Prisma.RundownItemFindFirstOrThrowArgs, "select" | "include">> = z.object({
...
export default RundownItemFindFirstOrThrowArgsSchema;
