...
export const LoadAssetJobFindFirstOrThrowArgsSchema: z.ZodType<
  Omit<Prisma.LoadAssetJobFindFirstOrThrowArgs, "select" | "include">
> = z
  .object({
...
export default LoadAssetJobFindFirstOrThrowArgsSchema;
