...
export const MetadataFieldFindFirstArgsSchema: z.ZodType<Omit<Prisma.MetadataFieldFindFirstArgs, "select" | "include">> = z.object({
...
export default MetadataFieldFindFirstArgsSchema;
