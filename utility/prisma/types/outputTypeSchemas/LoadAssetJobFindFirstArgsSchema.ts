...
export const LoadAssetJobFindFirstArgsSchema: z.ZodType<
  Omit<Prisma.LoadAssetJobFindFirstArgs, "select" | "include">
> = z
  .object({
...
export default LoadAssetJobFindFirstArgsSchema;
